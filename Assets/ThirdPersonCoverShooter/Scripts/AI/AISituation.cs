...
namespace CoverShooter
{
    ...
    public struct AISituation
    {
        ...
        public void ReadEnemyState(Actor actor)
        {
            ...
            LastSeenThreatTime = Time.realtimeSinceStartup;
        ...
        public void Update(AIController controller, AISituation previous, bool updateInDetail)
        {
            ...
            if (Threat == null || Threat.IsAttacking)
            ...
            if (IsAlerted)
            {
                ...
                if (updateInDetail)
                {
                    if (IsThreatInCover)
                    {
                        if (CurrentCover != null && CurrentCover.IsTall(controller.Motor.CoverSettings.TallThreshold))
                        {
