...
namespace CoverShooter
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        public bool EnableExposionPreview = true;
        ...
        private void Update()
        {
            ...
            if (!_isSprinting && Input.GetKey(KeyCode.LeftControl))
                _motor.InputCrouch();
            ...
            else
            {
                ...
                if (_motor.Gun != null && !_isSprinting)
                {
                    if (_isFiring)
                    {
                        _motor.InputFire();
