...
namespace CoverShooter
{
    ...
    public class CharacterAlerts : MonoBehaviour
    {
        ...
        public void OnLand()
        {
            _land.Start(transform.position, Land, _actor);
        }
        ...
        {
            _hurt.Start(transform.position, Hurt, _actor);
        }
        ...
        {
            _step.Start(transform.position, Step, _actor);
        }
        ...
        public void OnDead()
        {
            _death.Start(transform.position, Death, _actor);
        }
        ...
        public void OnJump()
        {
            _jump.Start(transform.position, Jump, _actor);
        }
    }
}
