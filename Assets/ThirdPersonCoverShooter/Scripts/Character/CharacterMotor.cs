    ...
    public class CharacterMotor : MonoBehaviour
    {
        ...
        public bool CanClimb
        {
            get
            {
                ...
                return _cover.Main.IsFrontField(_horizontalLookAngle, CoverSettings.Angles.Front);
            }
        }
        ...
        private void updateAnimator()
        {
            if (IsAlive)
            {
                ...
                var isInCover = _cover.In && (_isInCornerAimState || !IsAimingGun);
