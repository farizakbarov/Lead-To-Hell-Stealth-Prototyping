...
namespace Greyman{
	public class OffScreenIndicator : MonoBehaviour {
        ...
        public List<FixedTarget> targets = new List<FixedTarget>();
       // public List<FixedTarget> targets2 = new List<FixedTarget>();
        ...
        void Awake () {
			...
			*/
			...
			manager.CheckFields();
            //Debug.Log(GameManager.Singleton.AllAi.Count);
