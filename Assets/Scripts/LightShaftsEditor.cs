...
public class LightShaftsEditor : Editor
{
    ...
    SerializedProperty UseAllCameras;
   ...
   // SerializedProperty showInterpolatedSamples;
    ...
    public void OnEnable()
    {
        ...
        UseAllCameras = so.FindProperty("UseAllCameras");
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.PropertyField(UseAllCameras, true);
        ...
        if (shadowmapMode.enumValueIndex == 1)
        {
